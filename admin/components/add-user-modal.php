...
<div id="add-user-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form id="add-user-form" class="p-4 md:p-5">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2 inline-flex">
                        <input id="isVendor" type="checkbox" value="Vendor" class="mr-2 w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-600 dark:border-gray-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800">
                        <label for="isVendor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Vendor</label>
                    </div>
                </div>
                <button id="add-user-submit" type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
...
$(document).ready(function() {
    $('#add-user-form').submit(function(e) {
        ...
        var type = $('#isVendor').is(":checked") ? 'Vendor' : 'User';
        $.ajax({
            type: "POST",
            url: "../php_function/signupProcess.php",
            data: {
                name: name,
                email: email,
                password: password,
